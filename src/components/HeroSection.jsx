...
export default function HeroSection({ heroImage }) {
  return (
  <section className="relative min-h-[calc(100vh-5rem)] flex items-center overflow-hidden pt-20 pb-16 lg:pt-24 lg:pb-24">
  {/* Background */}
  ...
  <div className="relative max-w-7xl mx-auto px-6 w-full">
    ...
    >
      ...
      <h1 className="font-heading text-3xl sm:text-5xl lg:text-5xl xl:text-6xl leading-[1.15] tracking-tight mb-6">
        Фінансовий партнер для <br /> вашого бізнесу
      </h1>
